...
- (void)commonInit {
    ...
    self.selectionIndicatorBoxLayer.cornerRadius=5.0f;
}
...
//          CGFloat stringHeight = roundf([titleString sizeWithAttributes:@{NSFontAttributeName:self.font}]
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.type == HMSegmentedControlTypeText) {
       ...
       // [titleString sizeWithAttributes:@{NSFontAttributeName:self.font}]
